...
import LinkTableForQuery from '/@/components/jeecg/super/desform/LinkTableForQuery.vue';
import CascaderPcaForQuery from '/@/components/jeecg/super/desform/CascaderPcaForQuery.vue';
...
componentMap.set('CascaderPcaForQuery', CascaderPcaForQuery);
componentMap.set('LinkTableForQuery', LinkTableForQuery);
