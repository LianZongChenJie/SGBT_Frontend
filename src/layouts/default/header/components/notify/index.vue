<template>
  <div :class="prefixCls">
    ...
    <JNewChat ref="chatRef" @showMessageModal="clickBadge" @getSystemUnreadNum="getSystemUnreadNum" @getAddressBook="clickAddressBook" @clearAllUnMessage="clearAllUnMessage"></JNewChat>
  </div>
</template>
<script lang="ts">
  ...
  import JNewChat from "/@/components/JChat/JNewChat.vue";
  import AddressBook from "/@/views/super/eoa/addressbook/AddressBook.vue";
