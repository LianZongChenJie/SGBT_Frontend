...
//update-begin---author:wangshuai ---date:20220629  for：分享免登录------------
export const FileShareRoute: AppRouteRecordRaw = {
  path: "/file/share",
  name: "file-share",
  component: () => import("/@/views/super/eoa/file/commponent/FileShare.vue"),
  meta: {
    title: 'fileShare',
  }
};
//update-end---author:wangshuai ---date:20220629  for：分享免登录------------
...
export const basicRoutes = [LoginRoute, RootRoute, ...mainOutRoutes, REDIRECT_ROUTE, PAGE_NOT_FOUND_ROUTE, TokenLoginRoute, Oauth2LoginRoute, FileShareRoute, formUrlDetail, formUrlAdd, formUrlEdit, formUrlSuccess];
