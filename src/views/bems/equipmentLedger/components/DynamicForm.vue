<template>
  <a-spin :spinning="loading">
    <a-form class="deviceDynamicForm" ref="formRef" :model="formData" :label-col="{ span: 10 }" :wrapper-col="{ span: 14 }">
      <!-- 修改为使用 grid 布局的容器 -->
      ...
      <a-form-item>
        ...
        <div style="text-align: right">
          <a-button @click="resetForm" style="margin-right: 10px;">取消</a-button>
