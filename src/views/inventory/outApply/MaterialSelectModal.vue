<template>
  <BasicModal v-bind="$attrs" @register="registerModal" title="选择物料" @ok="handleSubmit" :width="1200" :z-index="1009" @open="searchReset">
    <!--自定义查询区域-->
...
<script lang="ts" setup name="OrderUserSelect">
  ...
  import { getLimitWarehouseList } from '@/views/inventory/InventoryManage/api';
  import { getSparePartsList } from './api';
  import { spareColumns } from './outapply.data';
