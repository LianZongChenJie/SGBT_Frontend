...
<script setup lang="ts" name="dynamic-notice">
  ...
  const componentType = {
    //update-begin---author:wangshuai ---date:20220523  for：换成异步组件加载，否则会影响到其他页面描述------------
    'modules/eoa/email/modals/EoaEmailInForm': defineAsyncComponent(() => import('/@/views/super/eoa/email/components/EoaMailBoxInForm.vue')),
    //update-end---author:wangshuai ---date:20220523  for：换成异步组件加载，否则会影响到其他页面描述------------
  };
