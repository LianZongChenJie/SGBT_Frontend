<template>
  <a-card :bordered="false" style="height: 100%">
    <a-spin :spinning="loading">
      <a-input-search placeholder="按空间名称搜索…" style="margin-bottom: 10px" @search="onSearch" />
      <!--组织机构树-->
        ...
        >
          <template #title="{ key: treeKey, title, dataRef }">
            <a-dropdown :trigger="['contextmenu']">
              ...
              <template #overlay>
                <a-menu @click="">
                  <a-menu-item key="3" @click="onEditChildDepart(dataRef)">修改</a-menu-item>
...
<script lang="ts" setup>
  import { inject, nextTick, ref, unref, reactive } from 'vue';
  ...
  //编辑
  const onEditChildDepart = (data = currentDepart.value) => {
    openEditModal(true, data);
  };
