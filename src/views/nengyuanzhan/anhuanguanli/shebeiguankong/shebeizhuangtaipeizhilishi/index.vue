<template>
  <div style="padding: 10px">
    <BasicTable @register="registerTable" :rowSelection="rowSelection" :class="{ 'p-4': customSearch }">
      <template #tableTitle>
<!--        <a-button preIcon="ant-design:plus-outlined" type="primary" @click="handleAdd">常开</a-button>-->
<!--        <a-button preIcon="ant-design:plus-outlined" type="primary" @click="handleAdd">常闭</a-button>-->
<!--        <a-button preIcon="ant-design:plus-outlined" type="primary" @click="handleAdd">正常</a-button>-->
<!--        <a-button preIcon="ant-design:plus-outlined" type="primary" @click="handleAdd">单次开</a-button>-->
...
<script lang="ts" setup name="shebeizhuangtaipeizhilishi">
