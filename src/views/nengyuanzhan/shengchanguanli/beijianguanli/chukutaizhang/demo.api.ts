...
export enum Api {
  ...
  list = '/operation/operationWhSheetOut/list',
  savePutong = '/operation/operationWhSheetOut/add',
  saveLingyong = '/operation/operationWhSheetOut/addApplicationOut',
  edit = '/operation/operationWhSheetOut/edit',
  get = '/operation/operationWhSheetOut/queryById',
  delete = '/operation/operationWhSheetOut/delete',
  deleteBatch = '/operation/operationWhSheetOut/deleteBatch',
  exportXls = '/operation/operationWhSheetOut/exportXls',
  importExcel = '/operation/operationWhSheetOut/importExcel',
...
export const getDetails = (params) => {
  return defHttp.get({ url: `/operation/operationWhSheetOut/${params}/detail` });
};
/**
 * 保存或者更新示例
 * @param params
 */
export const saveOrUpdateDemoPutong = (params, isUpdate) => {
  let url = isUpdate ? Api.edit : Api.savePutong;
  if (isUpdate) {
...
export const saveOrUpdateDemoLingyong = (params, isUpdate) => {
  let url = isUpdate ? Api.edit : Api.saveLingyong;
  if (isUpdate) {
    return defHttp.put({ url: url, params });
  } else {
    return defHttp.post({ url: url, params });
