...
<!--      <template #tableTitle>-->
<!--        <a-button preIcon="ant-design:plus-outlined" type="primary" @click="handleAdd">新增资料</a-button>-->
<!--&lt;!&ndash;        <a-upload name="file" :showUploadList="false" :customRequest="(file) => handleImportXls(file, getImportUrl, reload)">&ndash;&gt;-->
<!--&lt;!&ndash;          <a-button preIcon="ant-design:import-outlined" type="primary">导入</a-button>&ndash;&gt;-->
<!--&lt;!&ndash;        </a-upload>&ndash;&gt;-->
<!--&lt;!&ndash;        <a-button preIcon="ant-design:export-outlined" type="primary" @click="handleExportXls('单表示例', getExportUrl, exportParams)">&ndash;&gt;-->
<!--&lt;!&ndash;          导出&ndash;&gt;-->
...
<!--      </template>-->
    ...
    <DemoModalShenpi @register="registerModal1" @success="reload" :isDisabled="isDisabled" />
    <JImportModal @register="registerModalJimport" :url="getImportUrl" online />
  </div>
</template>
<script lang="ts" setup name="beijianshiyongshenpi">
  import { ref, unref, reactive, toRaw, watch, computed } from 'vue';
  import { BasicTable, useTable, TableAction } from '/@/components/Table';
  import { useModal } from '/@/components/Modal';
  import DemoModal from './DemoModal.vue';
  import DemoModalShenpi from './DemoModalShenpi.vue';
  ...
  const [registerModal1, { openModal:openModalShenpi }] = useModal();
