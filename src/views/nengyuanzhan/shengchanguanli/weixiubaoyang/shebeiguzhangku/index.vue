<template>
  <div style="padding: 10px">
    <BasicTable @register="registerTable" :rowSelection="rowSelection">
      <template #tableTitle>
        <a-button
          v-if="hasPermission('operation:operation_base_fault_library:add')"
        ...
        >
        <a-button
          v-if="hasPermission('operation:operation_base_fault_library:startOrStop')"
        ...
        <!--          导出-->
        <!--        </a-button>-->
        <a-dropdown v-if="checkedKeys.length > 0 && hasPermission('operation:operation_base_fault_library:deleteBatch')">
          <template #overlay>
            <a-menu>
              <a-menu-item v-if="hasPermission('operation:operation_base_fault_library:deleteBatch')" key="1" @click="batchHandleDelete">
...
<script lang="ts" setup name="shebeiguzhangku">
    ...
    return [
      {
        ...
        auth: 'operation:operation_base_fault_library:edit',
      },
      // {
      //   label: '详情',
      ...
      {
        label: '删除',
        auth: 'operation:operation_base_fault_library:delete',
        popConfirm: {
          title: '是否确认删除',
