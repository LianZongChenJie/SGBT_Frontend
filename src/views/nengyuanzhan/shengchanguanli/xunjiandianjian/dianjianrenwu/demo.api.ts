...
enum Api {
  list = '/operation/inspectionTask/checkList',
  save = '/operation/inspectionTask/checkAdd',
  edit = '/operation/inspectionTask/checkEdit',
  get = '/operation/inspectionTask/queryCheckById',
  delete = '/operation/inspectionTask/checkDelete',
  ...
  itemByTaskId = '/operation/inspectionTaskDetail/itemByTaskId',
  detailExecute = '/operation/inspectionTask/execute',
  saveDraft = '/operation/inspectionTask/saveDraft',
}
...
export const saveDetailDraft = (params) => {
...
export const getItemByTaskId = (params) => {
  return defHttp.get({ url: Api.itemByTaskId, params });
};
