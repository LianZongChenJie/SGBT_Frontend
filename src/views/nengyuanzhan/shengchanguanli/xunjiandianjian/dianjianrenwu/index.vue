      ...
      <BasicTable :rowSelection="rowSelection" @register="registerTable">
        <template #tableTitle>
          ...
          <a-button
            ...
            type="primary"
            @click="handleExportXls('点检任务', getExportUrl, exportParams)"
            >导出</a-button
          >
          ...
          <!--          下载模版-->
          <!--        </a-button>-->
          <a-dropdown v-if="checkedKeys.length > 0 && hasPermission('operation:operation_inspection_task:deleteBatch')">
            <template #overlay>
              <a-menu>
                <a-menu-item v-if="hasPermission('operation:operation_inspection_task:deleteBatch')" @click="batchHandleDelete">
