...
<script lang="ts" setup>
  ...
  //表单配置
  const [registerForm, { resetFields, setFieldsValue, validate, updateSchema, appendSchemaByField, removeSchemaByFiled, setProps, clearValidate }] =
    useForm({
      labelWidth: 150,
      labelCol: { span: 24 },
      wrapperCol: { span: 24 },
