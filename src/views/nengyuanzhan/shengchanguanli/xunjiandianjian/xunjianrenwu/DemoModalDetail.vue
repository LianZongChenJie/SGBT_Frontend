      ...
      <div id="printContent" class="mt5">
        <div class="flex justify-between ml5 mr5">
          <div>
            <p>
              <span>巡检班组:</span>
              <span>{{ editFormData.teamName }}</span>
            </p>
            <p>
              <span>巡检人:</span>
              <span>{{ editFormData.chargerName }}</span>
            </p>
          </div>
        ...
        <a-tabs v-model:activeKey="activeKey" class="ml5 mr5">
          ...
          <a-tab-pane key="2" tab="巡检明细">
            <Xunjianmingxi :data="editFormData"></Xunjianmingxi>
          </a-tab-pane>
          <a-tab-pane key="3" tab="巡检路线">
            <Xunjianluxian :data="editFormData"></Xunjianluxian>
          </a-tab-pane>
        </a-tabs>
      </div>
    </template>
...
<script lang="ts" setup>
  ...
  import Xunjianluxian from './components/Xunjianluxian.vue';
