...
//   searchBy = '/energy/dimSpace/searchBy',
//   queryDepartTreeSync = '/energy/dimSpace/querySpaceTreeSync',
//   save = '/energy/dimSpace/add',
//   edit = '/energy/dimSpace/edit',
//   delete = '/energy/dimSpace/delete',
//   deleteBatch = '/energy/dimSpace/deleteBatch',
...
export enum Api {
  searchBy = '/operation/dimSpace/searchBy',
  queryDepartTreeSync = '/operation/dimSpace/querySpaceTreeSync',
  save = '/operation/dimSpace/add',
  edit = '/operation/dimSpace/edit',
  delete = '/operation/dimSpace/delete',
  deleteBatch = '/operation/dimSpace/deleteBatch',
  TreeList = '/operation/dimSpace/ddl',
...
function buildSpacePayload(values: Record<string, unknown>) {
  const payload = {
    cadCode: toTrimmedString(values.cadCode),
    connSpace: toTrimmedString(values.connSpace),
    doorName: toTrimmedString(values.doorName),
    id: values.id,
    parentId: toNumberValue(values.parentId),
    spaceCode: toTrimmedString(values.spaceCode),
    spaceName: toTrimmedString(values.spaceName),
    spaceUsage: toTrimmedString(values.spaceUsage),
  };
 ...
 */
export const saveOrUpdateDepart = (params, isUpdate) => {
  const payload = buildSpacePayload(params);
  if (isUpdate) {
    return defHttp.put({ url: Api.edit, params: payload });
  } else {
    return defHttp.post({ url: Api.save, params: payload });
  }
};
 ...
 */
export const changeDepartChargePerson = (params) => defHttp.put({ url: Api.changeDepartChargePerson, params });
export const getTreeListSpace = (params?) => defHttp.get({ url: Api.TreeList, params });
