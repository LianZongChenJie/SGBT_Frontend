...
<script>
  ...
  export default {
    ...
    setup(_props, { emit }) {
      const { registerModal, registerLeftTable, registerRightTable, handleSubmit, rowSelection, handleDelete } = useSelectAuthField(true, emit);
