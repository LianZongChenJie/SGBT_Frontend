...
<script lang="ts" setup>
  ...
  import { list, batchDelete, deleteOne, getExportUrl, getImportUrl } from './issued.api';
  import { columns, searchFormSchema } from './issued.data';
  ...
  const { prefixCls, onExportXls, onImportXls, tableContext } = useListPage({
    designScope: 'issued-draft-template',
    tableProps: {
      title: '发文草稿箱列表',
      api: (params) => {
        //0 草稿箱 1 已发送
