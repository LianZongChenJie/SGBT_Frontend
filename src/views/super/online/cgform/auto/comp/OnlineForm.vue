        ...
        <div v-else>
          ...
          <JVxeTable
            ...
            <template #toolbarSuffix>
              <a-button v-if="!onlineFormDisabled && getBtnAuth('add', sub.key)" type="primary" @click="openSubFormModalForAdd(sub)">
                <div class="add">
                  <svg t="1714390025804" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="50960" width="16" height="16"><path d="M469.333333 469.333333V170.666667h85.333334v298.666666h298.666666v85.333334h-298.666666v298.666666h-85.333334v-298.666666H170.666667v-85.333334h298.666666z" fill="#fff" p-id="50961"></path></svg>
                  <diff-outlined />
                </div>
              </a-button>
              <a-button v-if="!onlineFormDisabled && getBtnAuth('update', sub.key)" type="primary" @click="openSubFormModalForEdit(sub)"><form-outlined /></a-button>
            </template>
...
<script>
  ...
  import { pick, omit, cloneDeep } from 'lodash-es';
