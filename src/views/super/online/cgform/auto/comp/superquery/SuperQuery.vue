<template>
    ...
    <div class="j-super-query-button">
        ...
        <a-button v-else type="primary" preIcon="ant-design:filter-outlined" @click="handleOpen">
            高级查询
        </a-button>
    </div>
    ...
    <!-- 高级查询弹框 -->
    <teleport to="body">
        <BasicModal title="高级查询构造器" wrap-class-name="j-super-query-modal" :canFullscreen="true" :width="850" @register="registerFormModal" @ok="handleSubmit" @fullScreen="handleFullScreen">
            <template #footer>
