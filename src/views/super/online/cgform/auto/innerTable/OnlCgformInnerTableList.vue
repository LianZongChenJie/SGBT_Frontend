<template>
  <div class="p-2">
    ...
    <!-- 表单新增、修改弹框 -->
    <OnlineAutoModal :id="ID" @register="registerModal" @success="hanldeSuccess" @formConfig="getSubColunm"></OnlineAutoModal>
...
<style lang="less">
  ...
  .j-table-force-nowrap {
    ...
    /** 列自适应，弊端会导致列宽失效 NY5LzSY2VW1BSthYSnJArCFqbgwtZqSuyPQ/OD1n1twWJGU2RN/wkzf+kBVO5Dzt1tfCXbTnBERDugH4sSiNJM6d9gGujlqrqH0iD13cmCMX7UK/DTuXabF/acqdT052YWaK9072jFdyt+5PXI+shQ== */
