<template>
    <div ref="tableLinkCardRef">
        ...
        <online-pop-list-modal @register="registerListModal" :multi="multi" :id="popTableName" :addAuth="auths.add" @success="addCard"></online-pop-list-modal>
        <!-- 弹窗到另外一张表单用-可编辑表单 -->
        <online-pop-modal :id="popTableName" @register="registerFormModal" @success="updateCardData" topTip></online-pop-modal>
    </div>
</template>
