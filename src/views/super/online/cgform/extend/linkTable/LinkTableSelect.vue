<template>
    <div class="link-table-select-box" ref="boxRef">
        ...
        <!-- 弹窗到另外一张表单用-可编辑表单 -->
        <online-pop-modal :id="popTableName" @register="registerPopModal" @success="getFormData" topTip></online-pop-modal>
    </div>
</template>
...
<script lang="ts">
  ...
  import {ref, computed, watch,toRaw, inject, onMounted, onBeforeUnmount } from 'vue'
