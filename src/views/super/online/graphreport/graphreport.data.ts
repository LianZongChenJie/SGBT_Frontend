    ...
    mapFormSchema(
      {
        ...
        dynamicRules() {
          return [
            {
              required: true,
              // 根据数据类型的不同显示不同的错误信息  NY5LzSY2VW1BSthYSnJArCFqbgwtZqSuyPQ/OD1n1twWJGU2RN/wkzf+kBVO5Dzt1tfCXbTnBERDugH4sSiNJM6d9gGujlqrqH0iD13cmCMX7UK/DTuXabF/acqdT052YWaK9072jFdyt+5PXI+shQ==
