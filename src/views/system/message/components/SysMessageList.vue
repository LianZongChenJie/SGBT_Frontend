      ...
      <a-list-item>
        ...
        <a-list-item-meta>
          <template #description>
            <div v-if="isDesignFormComment(item)" style="background: #f7f7f7;color: #555;padding: 2px 5px;white-space:nowrap;overflow: hidden">
...
<script>
  ...
  export default {
    ...
    setup(props, {emit}){
      ...
      // update-begin-author:taoyan date:2023-5-10 for: QQYUN-4744【系统通知】6、系统通知@人后，对方看不到是哪个表单@的，没有超链接
      const { goPage, currentModal, modalRegCache, bindParams, isDesignFormComment } = useMessageHref(emit, props);
