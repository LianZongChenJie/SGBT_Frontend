...
enum Api {
  ...
  getEventRole = '/jeecg-demo/admin/eventRole/findUserRoleWithCheck',
  saveUserRoleRelation = '/jeecg-demo/admin/eventRole/saveUserRoleRelation',
  ...
  getTreeData = '/jeecg-demo/userSpace/checkedTree',
  saveTreeData = '/jeecg-demo/userSpace/allocateSpace',
}

export const getEventRoles = (params) => defHttp.get({ url: Api.getEventRole, params }, { errorMessageMode: 'none' });
export const saveUserRoleRelation = (params) => {
  return defHttp.post({ url: Api.saveUserRoleRelation, params });
};
/**
 * 导出api
 * @param params
